...
import com.amolik.formfiling.SikuliFiscalFiller;
  ...
  public static int[] toJavaKeyCode(String key) {
    if (key.length() > 0) {
    	...
    	if(logger.isDebugEnabled()) {
    		logger.debug("char="+key.charAt(0)
    		             +"|"+toJavaKeyCode(key.charAt(0)));
    	}
...
//Uppercase
      ...
      // type acute characters
      case 'á': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_A};
      case 'é': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_E};
      case 'í': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_I};
      case 'ó': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_O};
      case 'ú': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_U};
      case 'ý': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_Y};
      case 'Á': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_SHIFT, KeyEvent.VK_A};
      case 'É': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_SHIFT, KeyEvent.VK_E};
      case 'Í': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_SHIFT, KeyEvent.VK_I};
      case 'Ó': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_SHIFT, KeyEvent.VK_O};
      case 'Ú': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_SHIFT, KeyEvent.VK_U};
      case 'Ý': return new int[]{KeyEvent.VK_DEAD_ACUTE, KeyEvent.VK_SHIFT, KeyEvent.VK_Y};
      
      // type grave characters
      case 'à': return new int[]{KeyEvent.VK_DEAD_GRAVE, KeyEvent.VK_A};
      case 'è': return new int[]{KeyEvent.VK_DEAD_GRAVE, KeyEvent.VK_E};
      case 'ì': return new int[]{KeyEvent.VK_DEAD_GRAVE, KeyEvent.VK_I};
      case 'ò': return new int[]{KeyEvent.VK_DEAD_GRAVE, KeyEvent.VK_O};
      case 'ù': return new int[]{KeyEvent.VK_DEAD_GRAVE, KeyEvent.VK_U};
      case 'À': return new int[]{KeyEvent.VK_DEAD_GRAVE, KeyEvent.VK_SHIFT, KeyEvent.VK_A};
      case 'È': return new int[]{KeyEvent.VK_DEAD_GRAVE, KeyEvent.VK_SHIFT, KeyEvent.VK_E};
      case 'Ì': return new int[]{KeyEvent.VK_DEAD_GRAVE, KeyEvent.VK_SHIFT, KeyEvent.VK_I};
      case 'Ò': return new int[]{KeyEvent.VK_DEAD_GRAVE, KeyEvent.VK_SHIFT, KeyEvent.VK_O};
      case 'Ù': return new int[]{KeyEvent.VK_DEAD_GRAVE, KeyEvent.VK_SHIFT, KeyEvent.VK_U};
      
   // circumflex characters
      case 'â': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_A};
      case 'ê': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_E};
      case 'î': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_I};
      case 'ô': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_O};
      case 'û': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_U};
      case 'Â': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_SHIFT, KeyEvent.VK_A};
      case 'Ê': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_SHIFT, KeyEvent.VK_E};
      case 'Î': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_SHIFT, KeyEvent.VK_I};
      case 'Ô': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_SHIFT, KeyEvent.VK_O};
      case 'Û': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_SHIFT, KeyEvent.VK_U};
      
    
      
      // dual characters
      case 'æ': return new int[]{KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_Z};
      case 'Æ': return new int[]{KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_SHIFT, KeyEvent.VK_Z};
      case 'å': return new int[]{KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_W};
      case 'Å': return new int[]{KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_SHIFT, KeyEvent.VK_W};
      
      // c characters
      case 'ç': return new int[]{KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_COMMA};
      case 'Ç': return new int[]{KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_SHIFT, KeyEvent.VK_COMMA};
      case '©': return new int[]{KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_C};
      case '¢': return new int[]{KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_SHIFT, KeyEvent.VK_C};
      
      // above double characters
       case 'ä': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_Q};
       case 'Ä': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_SHIFT, KeyEvent.VK_Q};
       case 'ö': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_P};
       case 'Ö': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_SHIFT, KeyEvent.VK_P};
       case 'ü': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_Y};
       case 'Ü': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_SHIFT, KeyEvent.VK_Y};
       
    // above double characters fake , remove later
       case 'ë': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_E};
       case 'Ë': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6,KeyEvent.VK_SHIFT, KeyEvent.VK_E};
       case 'ï': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6, KeyEvent.VK_I};
       case 'Ï': return new int[] {KeyEvent.VK_SHIFT,KeyEvent.VK_6,KeyEvent.VK_SHIFT, KeyEvent.VK_I};
       
       
       case 'ñ': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_N};
       case 'Ñ': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_SHIFT, KeyEvent.VK_N};
     
       // other special cases
       case '¡': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_1};
       case '€': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_5};
       case '«': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_OPEN_BRACKET};
       case '»': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, KeyEvent.VK_CLOSE_BRACKET};
      // case 'ã': return new int[] {KeyEvent.VK_CONTROL, KeyEvent.VK_ALT, 
    	//	   KeyEvent.VK_SHIFT,KeyEvent.VK_BACK_QUOTE,KeyEvent.VK_A};
       
       
   
     
//Row 3 (below function keys)
//      case 'Â§': return new int[]{192}; //not producable
